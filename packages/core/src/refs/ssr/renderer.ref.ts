...
// import { RENDERER_NAMES } from '../../values.js'
...
//     const initializeAllRenderers = Effect.gen(function* () {
//       yield* initializeRenderer(RENDERER_NAMES.PLANNING)
//       yield* initializeRenderer(RENDERER_NAMES.TOAST)
//     })
