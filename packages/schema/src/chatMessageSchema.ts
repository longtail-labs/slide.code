...
// File attachment schema for user prompts (supports any file type including images)
export const FileAttachmentSchema = Schema.Struct({
...
export type FileAttachment = Schema.Schema.Type<typeof FileAttachmentSchema>
